...
public class CubeGolemModel<T extends CubeGolemEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData CubeGolem = modelPartData.addChild("CubeGolem", ModelPartBuilder.create(), ModelTransform.of(0.0F, 4.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		ModelPartData arm = CubeGolem.addChild("arm", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 20.0F, 0.0F));
		...
		ModelPartData body = CubeGolem.addChild("body", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 20.0F, 0.0F));
		...
		ModelPartData leg = CubeGolem.addChild("leg", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 20.0F, 0.0F));
		...
		ModelPartData head = CubeGolem.addChild("head", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -12.0F, 0.0F));

		ModelPartData face = head.addChild("face", ModelPartBuilder.create().uv(0, 24).cuboid(-5.0F, -40.0F, -4.0F, 9.0F, 8.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 32.0F, 0.0F));

		ModelPartData righteye = head.addChild("righteye", ModelPartBuilder.create().uv(0, 24).cuboid(1.0F, -38.0F, 4.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 32.0F, 0.0F));

		ModelPartData lefteye = head.addChild("lefteye", ModelPartBuilder.create().uv(0, 3).cuboid(-4.0F, -38.0F, 4.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 32.0F, 0.0F));

		ModelPartData mouth = head.addChild("mouth", ModelPartBuilder.create().uv(0, 0).cuboid(-2.0F, -35.0F, 4.0F, 3.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 32.0F, 0.0F));
